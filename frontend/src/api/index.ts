...
export type {
  ...
  CreateBindingInput,
  UpdateBindingInput,
  CreateInterfaceMappingSetInput,
  UpdateInterfaceMappingSetInput,
  CreateInterfaceMappingGroupInput,
  UpdateInterfaceMappingGroupInput,
  CreateInterfaceMappingRuleInput,
  UpdateInterfaceMappingRuleInput,
