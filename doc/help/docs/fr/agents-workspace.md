...
- **Requêtes fournisseur max** (sous **Plus d'options**) — le nombre maximum d'appels que l'agent adresse au système de tickets à chaque contrôle, pour ne jamais le saturer.
