...
Deux autres surfaces IA se confondent facilement avec les agents, mais sont des choses distinctes : [Plaid](ai-assistant.md) est l'assistant de chat interactif que vous pilotez vous-même, et [Paramètres Plaid](ai-settings.md) est l'endroit où le fournisseur d'IA partagé est configuré.
