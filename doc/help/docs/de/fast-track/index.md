---
title: "Portfolio-Schnelleinstieg: Von der Anfrage zur Umsetzung"
description: Werden Sie schnell produktiv mit KANAPs Portfolio-Modul. Ein praktischer Schritt-für-Schritt-Leitfaden.
---
...
!!! tip "Bevorzugen Sie eine einseitige Zusammenfassung? :material-file-pdf-box:"
    ...
    [:material-download: Spickzettel herunterladen (PDF)](downloads/kanap-portfolio-fast-track.pdf){ .md-button .md-button--primary }

Für vollständige Details siehe die [Portfolio-Referenzdokumentation](../portfolio-requests.md).

---

## Das Gesamtbild

![Portfolio-Workflow-Übersicht](images/workflow-overview.png)
...
Für alle verfügbaren Felder und Optionen siehe [Anfragen-Referenz](../portfolio-requests.md).
...
!!! warning "Nicht alleine bewerten"
...
!!! example "Gute Empfehlungsbeispiele"
...
!!! info "Transparenz ist der Punkt"
...
Für detaillierte Bewertungskonfiguration und Gewichtsmanagement siehe [Einstellungen-Referenz](../portfolio-settings.md).
...
1. **Prüfen** Sie die Bewertungen, Machbarkeit und Empfehlung
2. **Bewegen Sie die Anfrage** durch **Kandidat**, **Wartend** oder **Abgelehnt**, während die Prüfung noch läuft
3. **Setzen Sie den Status** auf **Genehmigt**, wenn die Anfrage bereit ist, in die Umsetzung zu gehen
4. Klicken Sie auf **In Projekt konvertieren**

!!! tip "Nahtlose Übergabe"
...
Siehe [Anfragen-Referenz](../portfolio-requests.md) für alle Statusübergänge.
...
!!! warning "Mitwirkende müssen zuerst konfiguriert werden"
    ...
    Ohne Team-, Verfügbarkeits- und Fähigkeitsdaten kann der Roadmap-Generator keine Kapazität berechnen, und Ihre Planung fliegt blind. Siehe die [Mitwirkende-Referenz](../portfolio-team-members.md).
...
!!! info "Diese Zahlen speisen die Roadmap"
...
Siehe [Projekte-Referenz](../portfolio-projects.md) für alle Projektkonfigurationsoptionen.
...
!!! warning "Keine Zeiterfassung = keine automatische Planung"
...
1. **Fortschritt-Tab** -- Overhead-Zeit auf Projektebene erfassen (Besprechungen, Koordination, Management)
2. **Aufgaben** -- Aufgabenspezifische Zeit gegen einzelne Arbeitspakete erfassen
...
!!! tip "Machen Sie es zur Gewohnheit"
...
Siehe [Projekte-Referenz](../portfolio-projects.md) für Details zu jedem Status.
...
- Detaillierte Beschreibungen mit dem Markdown-Editor schreiben -- oder eine `.docx`-Datei direkt in das Beschreibungsfeld **importieren**
- Zeit direkt gegen Aufgaben erfassen (IT- oder Fachbereichskategorie)
...
!!! tip "Projektaufgaben müssen Zeit erfassen vor dem Abschluss"
...
!!! tip "Einfach beginnen, Struktur bei Bedarf hinzufügen"
...
Für vollständige Details zu Phasen, Aufgaben und Meilensteinen siehe [Projekte-Referenz](../portfolio-projects.md) und [Aufgaben-Referenz](../tasks.md).
...
Siehe [Planungs-Referenz](../portfolio-planning.md).
...
Siehe [Berichte-Referenz](../portfolio-reporting.md).
...
!!! success "Sie sind startklar"
    Sie kennen jetzt den vollständigen Lebenszyklus von der Anfrage zur Umsetzung. Beginnen Sie mit einer Anfrage, bewerten Sie sie richtig, und lassen Sie KANAP den Rest erledigen. Für detaillierte Dokumentation zu jeder Funktion erkunden Sie den Bereich [Portfolio](../portfolio-requests.md).
