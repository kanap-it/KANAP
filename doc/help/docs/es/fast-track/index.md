---
title: "Portafolio - Inicio Rápido: De la solicitud a la entrega"
description: Comience a ser productivo con el módulo de Portafolio de KANAP en minutos. Una guía práctica paso a paso.
---
...
!!! tip "Consejo"
    ...
    [:material-download: Descargar la hoja de referencia (PDF)](downloads/kanap-portfolio-fast-track.pdf){ .md-button .md-button--primary }

Para los detalles completos, consulte la [documentación de referencia del portafolio](../portfolio-requests.md).

---

## El panorama general

![Vista general del flujo de trabajo del portafolio](images/workflow-overview.png)
...
Para todos los campos y opciones disponibles, consulte la [referencia de Solicitudes](../portfolio-requests.md).
...
!!! example "Buenos ejemplos de recomendación"
...
Para la configuración detallada de evaluación y gestión de pesos, consulte la [referencia de Configuración](../portfolio-settings.md).
...
1. **Revise** las puntuaciones, viabilidad y recomendación
2. **Mueva la solicitud** a través de **Candidata**, **En espera** o **Rechazada** según necesite mientras la revisión aún está en curso
3. **Establezca el estado** a **Aprobada** cuando la solicitud esté lista para entrar en entrega
4. Haga clic en **Convertir en proyecto**
...
Consulte la [referencia de Solicitudes](../portfolio-requests.md) para todas las transiciones de estado.
...
!!! warning "Advertencia"
    ...
    Sin datos de equipo, disponibilidad y competencias, el generador de hoja de ruta no puede calcular la capacidad, y su planificación estará volando a ciegas. Consulte la [referencia de Colaboradores](../portfolio-team-members.md).
...
Consulte la [referencia de Proyectos](../portfolio-projects.md) para todas las opciones de configuración de proyectos.
...
1. **Pestaña Progreso** -- Registrar tiempo de gastos generales a nivel de proyecto (reuniones, coordinación, gestión)
2. **Tareas** -- Registrar tiempo específico de tarea contra elementos de trabajo individuales
...
Consulte la [referencia de Proyectos](../portfolio-projects.md) para detalles sobre cada estado.
...
- Escriba descripciones detalladas usando el editor markdown -- o **importe un archivo `.docx`** directamente en el campo Descripción
- Registre tiempo directamente contra las tareas (categoría IT o Negocio)
...
Para todos los detalles sobre fases, tareas e hitos, consulte la [referencia de Proyectos](../portfolio-projects.md) y la [referencia de Tareas](../tasks.md).
...
Consulte la [referencia de Planificación](../portfolio-planning.md).
...
Consulte la [referencia de Informes](../portfolio-reporting.md).
...
!!! success "Está listo"
    Ahora conoce el ciclo de vida completo desde la solicitud hasta la entrega. Comience con una solicitud, evalúela correctamente y deje que KANAP se encargue del resto. Para documentación detallada sobre cada funcionalidad, explore la sección de [Gestión de portafolio](../portfolio-requests.md).
