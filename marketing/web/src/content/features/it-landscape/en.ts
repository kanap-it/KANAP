...
const content: FeatureContent = {
  meta: {
    title: 'IT landscape',
    description:
      'Document applications, interfaces, and infrastructure. Interactive architecture maps, lifecycle tracking, 3-leg middleware. Open source. Self-host free or choose hosted cloud.',
  },
  header: {
